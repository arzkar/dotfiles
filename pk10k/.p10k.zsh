# Generated by Powerlevel10k configuration wizard on 2021-01-30 at 23:36 IST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # =========================[ Line #2 ]=========================
    newline                 # \n
    tw_release              # tumbleweed release version
  ...
  #
  typeset -g POWERLEVEL9K_DIR_CLASSES=() # Removes the dir icon
  ...
  typeset -g POWERLEVEL9K_VCS_BRANCH_ICON='%F{#bf00ff}\uF126 '
  ...
  function prompt_my_uptime(){
    uptime_var="$(awk '{print int($1/3600)"h "int(($1%3600)/60)"m"}' /proc/uptime)"
    p10k segment -f 208 -i '' -t '%F{cyan}'${uptime_var}
  }
  function prompt_tw_release(){
    tw_release_var="$(lsb_release -r | sed 's/Release://' | awk '{$1=$1};1')"
    p10k segment -f green -i '' -t '%F{green}'${tw_release_var}
  }
